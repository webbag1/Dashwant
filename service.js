...
let count_num_seo = 0;
function update_img_seo(count_num_seo) {
...
let count_num_web = 0;
function update_img_web(count_num_web) {
...
function update_img_meta(count_num_meta) {
...
chevron_right_meta.addEventListener('click', () => {
  if(count_num_meta == img_list_meta.length-1){
    count_num_meta = 0;
    update_img_meta(count_num_meta);
  }else{
    count_num_meta++;
    update_img_meta(count_num_meta);
  }
